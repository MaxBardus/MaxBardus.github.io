...
function home() {
    function t() {
        $("#line-web").addClass("animate"), $("#blob-1").addClass("animate"), setTimeout(function() {
...
function project() {
    ...
    }, $.featherlight.defaults.openSpeed = 400, $.featherlight.defaults.closeSpeed = 400, $(".gallery").featherlightGallery({
        galleryFadeIn: 200,
        galleryFadeOut: 250
...
/* function article() {
    ...
    e.setAttribute("id", "_carbonads_js"), e.setAttribute("src", "//cdn.carbonads.com/carbon.js?serve=CKYIV5QJ&placement=ivomynttinencom"), t.append(e), fusionMove(), $(window).on("resize", function() {
        fusionMove()
    }), $("#wrapfabtest").height() <= 0 && $(".no-fusion").removeClass("d-none"), $("body").scrollspy({
        target: "#toc",
        offset: 100
    })
} */
...
function main() {
    function t() {
        function t() {
            ...
            }), window.tallest = Math.max.apply(null, window.heights), $(".carousel-item").each(function() {
                $(this).css("min-height", tallest + "px")
            })
        }
        window.heights = [], window.tallest, t(), $(window).on("resize orientationchange", function() {
            window.tallest = 0, window.heights.length = 0, $(".carousel-item").each(function() {
    ...
    $('a[href*="#"]').not('[href="#"]').not('[href="#0"]').not('[href="mailto"]').not(".no-scroll").click(function(t) {
        ...
        $(".barba-navigation a").removeClass("active"), $(".view-" + t).addClass("active")
    }), setTimeout(function() {
        t()
    }, 100)
}! function t(e, n) {
...
var Util = function($) {
        ...
        function i() {
            $.fn.emulateTransitionEnd = n, $.event.special[a.TRANSITION_END] = e()
        }
        var o = "transitionend",
            r = 1e6,
            s = 1e3,
                ...
                typeCheckConfig: function e(n, i, o) {
                    for (var r in o)
                        if (Object.prototype.hasOwnProperty.call(o, r)) {
                            ...
                            if (!new RegExp(s).test(c)) throw new Error(n.toUpperCase() + ': Option "' + r + '" provided type "' + c + '" but expected type "' + s + '".')
                        }
                }
            };
        return i(), a
    ...
    ScrollSpy = function($) {
        var t = "scrollspy",
            ...
            d = function() {
                function e(t, e) {
                    var n = this;
                    this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(e), this._selector = this._config.target + " " + u.NAV_LINKS + "," + this._config.target + " " + u.LIST_ITEMS + "," + this._config.target + " " + u.DROPDOWN_ITEMS, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, $(this._scrollElement).on(l.SCROLL, function(t) {
                        return n._process(t)
                ...
                return o.refresh = function t() {
                    ...
                    $.removeData(this._element, n), $(this._scrollElement).off(i), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
                }, o._getConfig = function e(n) {
                    if (n = _objectSpread({}, s, "object" == typeof n && n ? n : {}), "string" != typeof n.target) {
                        var i = $(n.target).attr("id");
                        i || (i = Util.getUID(t), $(n.target).attr("id", i)), n.target = "#" + i
                    }
                    ...
                    i.hasClass(c.DROPDOWN_ITEM) ? (i.closest(u.DROPDOWN).find(u.DROPDOWN_TOGGLE).addClass(c.ACTIVE), i.addClass(c.ACTIVE)) : (i.addClass(c.ACTIVE), i.parents(u.NAV_LIST_GROUP).prev(u.NAV_LINKS + ", " + u.LIST_ITEMS).addClass(c.ACTIVE), i.parents(u.NAV_LIST_GROUP).prev(u.NAV_ITEMS).children(u.NAV_LINKS).addClass(c.ACTIVE)), $(this._scrollElement).trigger(l.ACTIVATE, {
                        relatedTarget: e
                    })
                }, o._clear = function t() {
                    ...
                    return this.each(function() {
                        var t = $(this).data(n),
                            o = "object" == typeof i && i;
                        if (t || (t = new e(this, o), $(this).data(n, t)), "string" == typeof i) {
    ...
    Carousel = function($) {
        var t = "carousel",
            ...
            m = function() {
                function e(t, e) {
                    this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !1, this.touchTimeout = null, this._config = this._getConfig(e), this._element = $(t)[0], this._indicatorsElement = $(this._element).find(p.INDICATORS)[0], this._addEventListeners()
                }
                var o = e.prototype;
                return o.next = function t() {
                    ...
                    e || (this._isPaused = !0), $(this._element).find(p.NEXT_PREV)[0] && (Util.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
                    ...
                    if (!(e > this._items.length - 1 || e < 0)) {
                        if (this._isSliding) return void $(this._element).one(d.SLID, function() {
                            return n.to(e)
                        });
                    ...
                    $(this._element).off(i), $.removeData(this._element, n), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
                }, o._getConfig = function e(n) {
                    return n = _objectSpread({}, c, n), Util.typeCheckConfig(t, n, u), n
                    ...
                    return this._items = $.makeArray($(e).parent().find(p.ITEM)), this._items.indexOf(e)
                }, o._getItemByDirection = function t(e, n) {
                    var i = e === h.NEXT,
                        o = e === h.PREV,
                        r = this._getItemIndex(n),
                        s = this._items.length - 1;
                    if ((o && 0 === r || i && r === s) && !this._config.wrap) return n;
                    var a = e === h.PREV ? -1 : 1,
                    ...
                    var i = this,
                        ...
                        c, u, m;
                    if (e === h.NEXT ? (c = f.LEFT, u = f.NEXT, m = h.LEFT) : (c = f.RIGHT, u = f.PREV, m = h.RIGHT), s && $(s).hasClass(f.ACTIVE)) return void(this._isSliding = !1);
                    if (!this._triggerSlideEvent(s, m).isDefaultPrevented() && o && s) {
                        ...
                        if ($(this._element).hasClass(f.SLIDE)) {
                            $(s).addClass(u), Util.reflow(s), $(o).addClass(c), $(s).addClass(c);
                            var v = Util.getTransitionDurationFromElement(o);
                            $(o).one(Util.TRANSITION_END, function() {
                                $(s).removeClass(c + " " + u).addClass(f.ACTIVE), $(o).removeClass(f.ACTIVE + " " + u + " " + c), i._isSliding = !1, setTimeout(function() {
                                    return $(i._element).trigger(g)
                                }, 0)
                            }).emulateTransitionEnd(v)
                        } else $(o).removeClass(f.ACTIVE), $(s).addClass(f.ACTIVE), this._isSliding = !1, $(this._element).trigger(g);
                        l && this.cycle()
                    }
                }, e._jQueryInterface = function t(i) {
                    return this.each(function() {
                        ...
                        if (t || (t = new e(this, o), $(this).data(n, t)), "number" == typeof i) t.to(i);
                    ...
                    if (o) {
                        ...
                        if (r && $(r).hasClass(f.CAROUSEL)) {
                            ...
                            a && (s.interval = !1), e._jQueryInterface.call($(r), s), a && $(r).data(n).to(a), i.preventDefault()
                        }
                    }
                }, _createClass(e, null, [{
                    key: "VERSION",
        ...
        return $(document).on(d.CLICK_DATA_API, p.DATA_SLIDE, m._dataApiClickHandler), $(window).on(d.LOAD_DATA_API, function() {
            $(p.DATA_RIDE).each(function() {
                var t = $(this);
                m._jQueryInterface.call(t, t.data())
            })
        }), $.fn[t] = m._jQueryInterface, $.fn[t].Constructor = m, $.fn[t].noConflict = function() {
...
! function(t) {
    ...
    return $.fn.tilt = function(t) {
        var e = function t() {
            ...
            n = function t() {
                var e = this;
                $(this).on("mousemove", s), $(this).on("mouseenter", o), this.settings.reset && $(this).on("mouseleave", a), this.settings.glare && $(window).on("resize", h.bind(e))
            },
            i = function t() {
                var e = this;
            ...
            o = function t(e) {
                ...
                }), i.call(this), $(this).trigger("tilt.mouseEnter")
            },
            r = function t(e) {
                return void 0 === e && (e = {
            ...
            a = function t() {
                i.call(this), this.reset = !0, e.call(this), $(this).trigger("tilt.mouseLeave")
            },
            l = function t() {
            ...
            c = function t() {
                if (this.transforms = l.call(this), this.reset) return this.reset = !1, $(this).css("transform", "perspective(" + this.settings.perspective + "px) rotateX(0deg) rotateY(0deg)"), void(this.settings.glare && (this.glareElement.css("transform", "rotate(180deg) translate(-50%, -50%)"), this.glareElement.css("opacity", "0")));
            ...
            u = function t() {
                ...
                if (e || $(this).append('<div class="js-tilt-glare"><div class="js-tilt-glare-inner"></div></div>'), this.glareElementWrapper = $(this).find(".js-tilt-glare"), this.glareElement = $(this).find(".js-tilt-glare-inner"), !e) {
                    var n = {
                        position: "absolute",
                        top: "0",
                        left: "0",
        ...
        return $.fn.tilt.destroy = function() {
            ...
            $(this).each(function() {
                var t = this;
                this.mousePositions = r.call(this), this.settings = $(this).data("settings"), a.call(this), setTimeout(function() {
                    t.reset = !1
            ...
            this.settings = $.extend({
                ...
                $(e).data("settings", e.settings), e.settings.glare && u.call(e), n.call(e)
            }, this.init()
        })
    }, $("[data-tilt]").tilt(), !0
}),
    ...
    if (n.getElementsByClassName) {
        var i, o, r = n.documentElement,
            ...
            T = function(t, e, o, r, s) {
                ...
                return o || (o = {}), o.instance = i, a.initCustomEvent(e, !r, !s, o), t.dispatchEvent(a), a
            },
            C = function(t, n) {
                var i;
            ...
            I = function() {
                var t, e, i = [],
                    ...
                    s = function() {
                        var n = r;
                        for (r = i.length ? o : i, t = !0, e = !1; n.length;) n.shift()();
                        t = !1
                    },
                    a = function(i, o) {
                        t && !o ? i.apply(this, arguments) : (r.push(i), e || (e = !0, (n.hidden ? h : d)(s)))
                    };
            ...
            S = function(t) {
                ...
                return function(t) {
                    var o;
                    (t = !0 === t) && (r = 33), e || (e = !0, o = i - (s.now() - n), o < 0 && (o = 0), t || o < 9 ? l() : h(l, o))
                }
            },
            O = function(t) {
                var e, n, i = 99,
        ...
        var P = function() {
                var t, a, d, f, m, g, x, P, k, j, L, N, H, R, V = /^img$/i,
                    ...
                    U = -1,
                    q = function(t) {
                        W--, t && t.target && _(t.target, q), (!t || W < 0 || !t.target) && (W = 0)
                    },
                    Y = function(t, e) {
                        var i, o = t,
                            s = "hidden" == E(n.body, "visibility") || "hidden" != E(t, "visibility");
                        for (P -= e, L += e, k -= e, j += e; s && (o = o.offsetParent) && o != n.body && o != r;)(s = (E(o, "opacity") || 1) > 0) && "visible" != E(o, "overflow") && (i = o.getBoundingClientRect(), s = j > i.left && k < i.right && L > i.top - 1 && P < i.bottom + 1);
                        return s
                    },
                    K = function() {
                        var e, s, l, u, h, d, p, m, v, y = i.elements;
                        if ((f = o.loadMode) && W < 8 && (e = y.length)) {
                            s = 0, U++, null == H && ("expand" in o || (o.expand = r.clientHeight > 500 && r.clientWidth > 500 ? 500 : 370), N = o.expand, H = N * o.expFactor), F < H && W < 1 && U > 2 && f > 2 && !n.hidden ? (F = H, U = 0) : F = f > 1 && U > 1 && W < 6 ? N : 0;
                            for (; s < e; s++)
                                if (y[s] && !y[s]._lazyRace)
                                    if (B)
                                        if ((m = y[s][c]("data-expand")) && (d = 1 * m) || (d = F), v !== d && (g = innerWidth + d * R, x = innerHeight + d, p = -1 * d, v = d), l = y[s].getBoundingClientRect(), (L = l.bottom) >= p && (P = l.top) <= x && (j = l.right) >= p * R && (k = l.left) <= g && (L || j || k || P) && (o.loadHidden || "hidden" != E(y[s], "visibility")) && (a && W < 3 && !m && (f < 3 || U < 4) || Y(y[s], d))) {
                                            if (nt(y[s]), h = !0, W > 9) break
                                        } else !h && a && !u && W < 4 && U < 4 && f > 2 && (t[0] || o.preloadAfterLoad) && (t[0] || !m && (L || j || k || P || "auto" != y[s][c](o.sizesAttr))) && (u = t[0] || y[s]);
                            else nt(y[s]);
                            u && !h && nt(u)
                        }
                    },
                    G = S(K),
                    X = function(t) {
                        w(t.target, o.loadedClass), b(t.target, o.loadingClass), _(t.target, Z), T(t.target, "lazyloaded")
                    },
                    Q = A(X),
                    Z = function(t) {
                        Q({
                    ...
                    et = A(function(t, e, n, i, r) {
                        var s, a, l, u, f, m;
                        (f = T(t, "lazybeforeunveil", e)).defaultPrevented || (i && (n ? w(t, o.autosizesClass) : t.setAttribute("sizes", i)), a = t[c](o.srcsetAttr), s = t[c](o.srcAttr), r && (l = t.parentNode, u = l && p.test(l.nodeName || "")), m = e.firesLoad || "src" in t && (a || s || u), f = {
                            target: t
                        }, m && (_(t, q, !0), clearTimeout(d), d = h(q, 2500), w(t, o.loadingClass), _(t, Z, !0)), u && v.call(l.getElementsByTagName("source"), tt), a ? t.setAttribute("srcset", a) : s && !u && (z.test(t.nodeName) ? J(t, s) : t.src = s), r && (a || u) && C(t, {
                            src: s
                        })), t._lazyRace && delete t._lazyRace, b(t, o.lazyClass), I(function() {
                            (!m || t.complete && t.naturalWidth > 1) && (m ? q(f) : W--, X(f))
                        }, !0)
                    }),
                    nt = function(t) {
                        var e, n = V.test(t.nodeName),
                            ...
                            r = "auto" == i;
                        (!r && a || !n || !t[c]("src") && !t.srcset || t.complete || y(t, o.errorClass) || !y(t, o.lazyClass)) && (e = T(t, "lazyunveilread").detail, r && D.updateElem(t, !0, t.offsetWidth), t._lazyRace = !0, W++, et(t, e, r, i, n))
                    },
                    it = function() {
                        if (!a) {
                ...
                return {
                    _: function() {
                        m = s.now(), i.elements = n.getElementsByClassName(o.lazyClass), t = n.getElementsByClassName(o.lazyClass + " " + o.preloadClass), R = o.hFac, u("scroll", G, !0), u("resize", G, !0), e.MutationObserver ? new MutationObserver(G).observe(r, {
                            childList: !0,
                            subtree: !0,
                            attributes: !0
                            ...
                            n[l](t, G, !0)
                        }), /d$|^c/.test(n.readyState) ? it() : (u("load", it), n[l]("DOMContentLoaded", G), h(it, 2e4)), i.elements.length ? (K(), I._lsFlush()) : G()
                    },
                    checkElems: G,
                    unveil: nt
                }
            ...
            D = function() {
                var t, e = A(function(t, e, n, i) {
                    ...
                    i = function(t, n, i) {
                        ...
                        r && (i = x(t, r, i), o = T(t, "lazybeforesizes", {
                            width: i,
                            dataAttr: !!n
...
function(t, e) {
    ...
    function n(t) {
        ...
        for (o = 1; o < arguments.length; o++) {
            var s = arguments[o] || {};
            for (i in s) "object" != typeof r[i] || e(r[i]) ? r[i] = r[i] || s[i] : r[i] = n(r[i], s[i])
        }
        return r
    }
...
function($) {
    ...
    if (void 0 === $) return void("console" in window && window.console.info("Too much lightness, Featherlight needs jQuery."));
    var i = [],
        o = function(t) {
        ...
        a = function(e) {
            $.each(t.opened().reverse(), function() {
                if (!e.isDefaultPrevented() && !1 === this[s[e.type]](e)) return e.preventDefault(), e.stopPropagation(), !1
            })
        },
        l = function(e) {
    ...
    t.prototype = {
        ...
        setup: function(t, e) {
            "object" != typeof t || t instanceof $ != !1 || e || (e = t, t = void 0);
            var n = $.extend(this, e, {
                    target: t
                }),
            ...
            return n.$instance = o.clone().addClass(n.variant), n.$instance.on(n.closeTrigger + "." + n.namespace, function(t) {
                var e = $(t.target);
                ("background" === n.closeOnClick && e.is("." + n.namespace) || "anywhere" === n.closeOnClick || e.closest(r).length) && (n.close(t), t.preventDefault())
            }), this
        },
        getContent: function() {
            ...
            var t = this,
                ...
                o = t.target || i || "",
                r = e[t.type];
            if (!r && o in e && (r = e[o], o = t.target && i), o = o || n("href") || "", !r)
                for (var s in e) t[s] && (r = e[s], o = t[s]);
            if (!r) {
                var a = o;
                if (o = null, $.each(t.contentFilters, function() {
                        return r = e[this], r.test && (o = r.test(a)), !o && r.regex && a.match && a.match(r.regex) && (o = a), !o
        ...
        setContent: function(t) {
            var e = this;
            return t.is("iframe") && e.$instance.addClass(e.namespace + "-iframe"), e.$instance.removeClass(e.namespace + "-loading"), e.$instance.find("." + e.namespace + "-inner").not(t).slice(1).remove().end().replaceWith($.contains(e.$instance[0], t[0]) ? "" : t), e.$content = t.addClass(e.namespace + "-inner"), e
        },
        open: function(t) {
            var e = this;
            if (e.$instance.hide().appendTo(e.root), !(t && t.isDefaultPrevented() || !1 === e.beforeOpen(t))) {
                t && t.preventDefault();
                var n = e.getContent();
                if (n) return i.push(e), l(!0), e.$instance.fadeIn(e.openSpeed), e.beforeContent(t), $.when(n).always(function(n) {
                    e.setContent(n), e.afterContent(t)
                }).then(e.$instance.promise()).done(function() {
                    e.afterOpen(t)
                })
            }
            return e.$instance.detach(), $.Deferred().reject().promise()
        },
        close: function(t) {
            var e = this,
                n = $.Deferred();
            return !1 === e.beforeClose(t) ? n.reject() : (0 === o(e).length && l(!1), e.$instance.fadeOut(e.closeSpeed, function() {
        ...
        readElementConfig: function(t, e) {
            ...
            return t && t.attributes && $.each(t.attributes, function() {
                ...
                if (t) {
                    var e = this.value,
                        r = $.camelCase(t[1]);
                    if ($.inArray(r, n.functionAttributes) >= 0) e = new Function(e);
                    else try {
                        e = JSON.parse(e)
                    } catch (t) {}
                    o[r] = e
        ...
        extend: function(t, e) {
            ...
            return n.prototype = this.prototype, t.prototype = new n, t.__super__ = this.prototype, $.extend(t, this, e), t.defaults = t.prototype, t
        },
        attach: function(t, e, n) {
            var i = this;
            "object" != typeof e || e instanceof $ != !1 || n || (n = e, e = void 0), n = $.extend({}, n);
            var o = n.namespace || i.defaults.namespace,
                ...
                s, a = function(o) {
                    ...
                    "shared" === c.persist ? s = c : !1 !== c.persist && a.data("featherlight-persisted", c), l.$currentTarget.blur && l.$currentTarget.blur(), c.open(o)
                };
        ...
        _callbackChain: {
            onKeyUp: function(t, e) {
                return 27 === e.keyCode ? (this.closeOnEsc && $.featherlight.close(e), !1) : t(e)
            },
            beforeOpen: function(t, e) {
                return this._previouslyActive = document.activeElement, this._$previouslyTabbable = $("a, input, select, textarea, iframe, button, iframe, [contentEditable=true]").not("[tabindex]").not(this.$instance.find("button")), this._$previouslyWithTabIndex = $("[tabindex]").not('[tabindex="-1"]'), this._previousWithTabIndices = this._$previouslyWithTabIndex.map(function(t, e) {
                    return $(e).attr("tabindex")
                }), this._$previouslyWithTabIndex.add(this._$previouslyTabbable).attr("tabindex", -1), document.activeElement.blur && document.activeElement.blur(), t(e)
            },
            afterClose: function(t, e) {
                var n = t(e),
                    i = this;
                return this._$previouslyTabbable.removeAttr("tabindex"), this._$previouslyWithTabIndex.each(function(t, e) {
            ...
            afterContent: function(t, e) {
                var n = t(e);
                return this.$instance.find("[autofocus]:not([disabled])").focus(), this.onResize(e), n
            }
        }
    }), $.featherlight = t, $.fn.featherlight = function(e, n) {
...
function($) {
    ...
    var s = {
        afterClose: function(t, e) {
            var n = this;
            return n.$instance.off("next." + n.namespace + " previous." + n.namespace), n._swiper && (n._swiper.off("swipeleft", n._swipeleft).off("swiperight", n._swiperight), n._swiper = null), t(e)
        },
        beforeOpen: function(t, e) {
            var n = this;
            ...
            }), n.$instance.addClass(this.namespace + "-swipe-aware", r)), n.$instance.find("." + n.namespace + "-content").append(n.createNavigation("previous")).append(n.createNavigation("next")), t(e)
        },
        beforeContent: function(t, e) {
            var n = this.currentNavigation(),
                i = this.slides().length;
            return this.$instance.toggleClass(this.namespace + "-first-slide", 0 === n).toggleClass(this.namespace + "-last-slide", n === i - 1), t(e)
        },
        onKeyUp: function(t, e) {
            var n = {
                37: "previous",
    ...
    $.featherlight.extend(t, {
        ...
        navigateTo: function(t) {
            ...
            return t = (t % i + i) % i, e.$currentTarget = n.eq(t), e.beforeContent(), $.when(e.getContent(), o.fadeTo(e.galleryFadeOut, 0)).always(function(t) {
                t.css("opacity", 0), e.setContent(t), e.afterContent(), t.fadeTo(e.galleryFadeIn, 1)
            })
        },
    ...
    }), $.featherlightGallery = t, $.fn.featherlightGallery = function(e) {
...
}), main(), Barba.Pjax.start(), Barba.Prefetch.init(), Barba.Dispatcher.on("newPageReady", function(t, e, n) {
    main()
...
var FadeTransition = Barba.BaseTransition.extend({
    ...
    fadeOut: function() {
        ...
        }), $("body").removeClass("menu-open"), $(".mobile-menu").fadeOut(300).removeClass("in"), $(this.oldContainer).delay(500).promise()
    },
    fadeIn: function() {
        var t = this,
            e = $(this.newContainer);
        ...
        }), $(this.oldContainer).hide(), $("html, body").scrollTop(0), e.css({
            visibility: "visible",
            opacity: 0
        }), e.animate({
            opacity: 1
        }, 600, function() {
            t.done(), $(".barba-layer").remove(), $("body").append('<div class="barba-layer" style="transform:translateY(100%)"></div>')
        })
    }
});
